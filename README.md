...
The core calculations are done with only a single dependency on [Numpy](https://numpy.org/doc/2.4/reference/index.html#reference) while other dependencies like [Polars](https://docs.pola.rs/api/python/stable/reference/) and [Matplotlib](https://matplotlib.org/stable/api/index.html) were brought in only for data export and calculation debugging.
